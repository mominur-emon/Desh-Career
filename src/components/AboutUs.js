        ...
        <Container className="main">
          <Row>
            <Col sm={12} md={8} lg={8} xl={8} className="about-wrp">
              <h1>About Us</h1>
              <p>
                Desh Career is a Career-based newsletter in the Bengali
                language. This newsletter is published weekly. It is published
                every Saturday at 12.00 PM.
              </p>
              <p>We focus on career trends, news, and smart jobs.</p>
              <p>
